...
class GerenciadorLista {
   ...
   constructor(){
    ...
    document.getElementById(this.idEdicao).children[0].innerText = nome
    document.getElementById(this.idEdicao).children[1].innerText = idade
    this.idEdicao = null
   }
}
        }
